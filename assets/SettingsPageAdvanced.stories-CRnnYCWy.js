import{S as J}from"./SettingsPageAdvanced-BdwnyL6e.js";import{s as e}from"./settings-CvAGLwBv.js";import"./edge-cases-CRkSQ-i-.js";import"./jsx-runtime-u17CrQMm.js";import"./iframe-BGtqOInk.js";import"./preload-helper-PPVm8Dsz.js";import"./Icon-B2foTpRx.js";import"./chevron-right-BYj65MRz.js";import"./rruleset-Bu4wjl4G.js";import"./Motion-BTKb_TxN.js";import"./proxy-DEXR2x0b.js";import"./index-CNQ5PkYJ.js";import"./datetime-CoIMkCUY.js";import"./tasks-D2syl_55.js";const{expect:o,within:l}=__STORYBOOK_MODULE_TEST__,ce={title:"Settings/SettingsPageAdvanced",component:J,tags:["autodocs"],parameters:{layout:"padded"},argTypes:{onUpdateSettings:{action:"settings-updated"}}},t=a=>console.log("Updated settings:",a),i={args:{settings:e.default(),onUpdateSettings:t,availableTags:["work","personal","urgent"]}},d={args:{...i.args,availableTags:[]}},c={args:{...i.args,availableTags:["work","personal","urgent","client","project-alpha","project-beta","bug","feature","documentation","testing"]}},u={args:{settings:{...e.default(),aiConfig:{...e.default().aiConfig,enabled:!1}},onUpdateSettings:t,availableTags:["work","personal"]}},m={args:{settings:{...e.default(),aiConfig:{...e.default().aiConfig,enabled:!0,defaultMode:!1}},onUpdateSettings:t,availableTags:["work","personal"]}},p={args:{settings:e.withAI(),onUpdateSettings:t,availableTags:["work","personal"]}},b={args:{settings:e.withAI({aiConfig:{enabled:!0,defaultMode:!0,activeProvider:"gemini",providers:{gemini:{apiKey:"test-gemini-key",model:"gemini-2.0-flash",baseUrl:""},openai:{apiKey:"",model:"gpt-4o",baseUrl:""},anthropic:{apiKey:"",model:"claude-sonnet-4-20250514",baseUrl:""},"openai-compatible":{apiKey:"",model:"",baseUrl:""}},systemPrompt:""}}),onUpdateSettings:t,availableTags:["work","personal"]}},S={args:{settings:e.withAI({aiConfig:{enabled:!0,defaultMode:!0,activeProvider:"openai",providers:{gemini:{apiKey:"",model:"gemini-2.0-flash",baseUrl:""},openai:{apiKey:"sk-test-openai-key",model:"gpt-4o",baseUrl:""},anthropic:{apiKey:"",model:"claude-sonnet-4-20250514",baseUrl:""},"openai-compatible":{apiKey:"",model:"",baseUrl:""}},systemPrompt:""}}),onUpdateSettings:t,availableTags:["work","personal"]}},v={args:{settings:e.withAI({aiConfig:{enabled:!0,defaultMode:!0,activeProvider:"anthropic",providers:{gemini:{apiKey:"",model:"gemini-2.0-flash",baseUrl:""},openai:{apiKey:"",model:"gpt-4o",baseUrl:""},anthropic:{apiKey:"sk-ant-test-key",model:"claude-sonnet-4-20250514",baseUrl:""},"openai-compatible":{apiKey:"",model:"",baseUrl:""}},systemPrompt:""}}),onUpdateSettings:t,availableTags:["work","personal"]}},h={args:{settings:e.allProvidersConfigured(),onUpdateSettings:t,availableTags:["work","personal"]}},f={args:{settings:{...e.withAI(),aiConfig:{enabled:!0,defaultMode:!0,activeProvider:"openai",providers:{gemini:{apiKey:"",model:"gemini-2.0-flash",baseUrl:""},openai:{apiKey:"sk-test-key",model:"gpt-4o",baseUrl:"https://custom-api.example.com"},anthropic:{apiKey:"",model:"claude-sonnet-4-20250514",baseUrl:""},"openai-compatible":{apiKey:"",model:"",baseUrl:""}},systemPrompt:""}},onUpdateSettings:t,availableTags:["work","personal"]}},y={args:{settings:{...e.withAI(),totalTokenUsage:125e3},onUpdateSettings:t,availableTags:["work","personal"]}},w={args:{settings:{...e.default(),voiceConfig:{...e.default().voiceConfig,enabled:!1}},onUpdateSettings:t,availableTags:["work","personal"]}},U={args:{settings:{...e.withVoiceInput(),voiceConfig:{...e.withVoiceInput().voiceConfig,activeProvider:"browser"}},onUpdateSettings:t,availableTags:["work","personal"]}},k={args:{settings:{...e.withVoiceInput(),voiceConfig:{...e.withVoiceInput().voiceConfig,activeProvider:"openai",providers:{...e.withVoiceInput().voiceConfig.providers,openai:{apiKey:"sk-test-key",baseUrl:"https://api.openai.com/v1/audio/transcriptions",model:"whisper-1"}}}},onUpdateSettings:t,availableTags:["work","personal"]}},T={args:{settings:{...e.withVoiceInput(),voiceConfig:{...e.withVoiceInput().voiceConfig,activeProvider:"gemini",providers:{...e.withVoiceInput().voiceConfig.providers,gemini:{apiKey:"AIza-test-key",model:"gemini-1.5-flash"}}}},onUpdateSettings:t,availableTags:["work","personal"]}},B={args:{...i.args,settings:{...e.default(),filters:{tags:[],categories:[],priorities:[],statuses:[],enableScript:!1,script:""}}}},g={args:{settings:e.withFilterScript("return task.priority === 'high';"),onUpdateSettings:t,availableTags:["work","personal"]}},A={args:{settings:e.withFilterScript("return task.priority === 'high' && task.tags.some(t => t.name === 'urgent');"),onUpdateSettings:t,availableTags:["work","personal","urgent"]}},C={args:{settings:e.withFilterScript("return task.invalid syntax here"),onUpdateSettings:t,availableTags:["work","personal"]}},I={args:{settings:{...e.default(),sort:{field:"dueAt",direction:"asc",script:""}},onUpdateSettings:t,availableTags:["work","personal"]}},P={args:{settings:{...e.default(),sort:{field:"createdAt",direction:"asc",script:""}},onUpdateSettings:t,availableTags:["work","personal"]}},F={args:{settings:{...e.default(),sort:{field:"priority",direction:"desc",script:""}},onUpdateSettings:t,availableTags:["work","personal"]}},D={args:{settings:{...e.default(),sort:{field:"title",direction:"asc",script:""}},onUpdateSettings:t,availableTags:["work","personal"]}},E={args:{settings:{...e.default(),sort:{field:"dueAt",direction:"desc",script:""}},onUpdateSettings:t,availableTags:["work","personal"]}},K={args:{settings:e.withSortScript("return a.title.localeCompare(b.title);"),onUpdateSettings:t,availableTags:["work","personal"]}},x={args:{settings:e.withSortScript("const priorityOrder = { high: 3, medium: 2, low: 1 }; return priorityOrder[b.priority] - priorityOrder[a.priority];"),onUpdateSettings:t,availableTags:["work","personal"]}},V={args:{settings:{...e.default(),filters:{...e.default().filters,tags:["work","urgent"]}},onUpdateSettings:t,availableTags:["work","personal","urgent","client"]}},G={args:{settings:{...e.default(),filters:{...e.default().filters,tags:["work","personal","urgent"]}},onUpdateSettings:t,availableTags:["work","personal","urgent"]}},O={args:{...i.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find Enable AI toggle",async()=>{const r=s.getAllByRole("button");o(r.length).toBeGreaterThan(0)})}},R={args:{...p.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find AI provider buttons",async()=>{const r=s.getAllByRole("button");o(r.length).toBeGreaterThan(2)})}},M={args:{...p.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find API key input",async()=>{const r=s.getAllByDisplayValue("");o(r.length).toBeGreaterThan(0)})}},W={args:{...i.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find Voice Input toggle",async()=>{const r=s.getAllByRole("button");o(r.length).toBeGreaterThan(0)})}},_={args:{...c.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find tag filter buttons",async()=>{const r=s.getAllByRole("button");o(r.length).toBeGreaterThan(5)})}},L={args:{...i.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find Script Filter toggle",async()=>{const r=s.getAllByRole("button");o(r.length).toBeGreaterThan(0)})}},j={args:{...g.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find filter script textarea",async()=>{const r=s.getAllByRole("textbox");o(r.length).toBeGreaterThan(0)})}},z={args:{...i.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find sort field selector",async()=>{const r=s.getAllByRole("combobox");o(r.length).toBeGreaterThan(0)})}},H={args:{...i.args},play:async({canvasElement:a,step:n})=>{const s=l(a);await n("Find sort direction button",async()=>{const r=s.getAllByRole("button");o(r.length).toBeGreaterThan(0)})}},N={args:{settings:{...e.allProvidersConfigured(),voiceConfig:{enabled:!0,activeProvider:"gemini",language:"",providers:{browser:{},openai:{apiKey:"sk-test-key",baseUrl:"https://api.openai.com/v1/audio/transcriptions",model:"whisper-1"},gemini:{apiKey:"AIza-test-key",model:"gemini-1.5-flash"}}},filters:{tags:["work","urgent"],categories:[],priorities:[],statuses:[],enableScript:!0,script:"return task.priority === 'high';"},sort:{field:"custom",direction:"asc",script:"return a.title.localeCompare(b.title);"},totalTokenUsage:5e5},onUpdateSettings:t,availableTags:["work","personal","urgent","client"]}},Y={args:{settings:{...e.default(),aiConfig:{...e.default().aiConfig,enabled:!1},voiceConfig:{...e.default().voiceConfig,enabled:!1},filters:{tags:[],categories:[],priorities:[],statuses:[],enableScript:!1,script:""}},onUpdateSettings:t,availableTags:[]}},q={args:{settings:e.withFilterScript(`// This is a very long filter script with multiple lines
...
}`,...q.parameters?.docs?.source}}};const ge=["Default","NoTags","ManyTags","AIDisabled","AIEnabledDefaultOff","AIEnabledDefaultOn","GeminiProvider","OpenAIProvider","AnthropicProvider","AllProvidersConfigured","WithCustomBaseURL","WithTokenUsage","VoiceInputDisabled","VoiceInputBrowser","VoiceInputOpenAI","VoiceInputGemini","FilterScriptDisabled","FilterScriptEnabled","ComplexFilterScript","FilterScriptWithError","SortByDueDate","SortByCreatedDate","SortByPriority","SortByTitle","SortDescending","CustomSortScript","ComplexSortScript","WithSelectedTags","AllTagsSelected","ToggleAIEnabled","SwitchAIProvider","EnterAPIKey","ToggleVoiceInput","SelectTagFilter","EnableFilterScript","TypeFilterScript","ChangeSortField","ToggleSortDirection","AllFeaturesEnabled","AllFeaturesDisabled","VeryLongScript"];export{u as AIDisabled,m as AIEnabledDefaultOff,p as AIEnabledDefaultOn,Y as AllFeaturesDisabled,N as AllFeaturesEnabled,h as AllProvidersConfigured,G as AllTagsSelected,v as AnthropicProvider,z as ChangeSortField,A as ComplexFilterScript,x as ComplexSortScript,K as CustomSortScript,i as Default,L as EnableFilterScript,M as EnterAPIKey,B as FilterScriptDisabled,g as FilterScriptEnabled,C as FilterScriptWithError,b as GeminiProvider,c as ManyTags,d as NoTags,S as OpenAIProvider,_ as SelectTagFilter,P as SortByCreatedDate,I as SortByDueDate,F as SortByPriority,D as SortByTitle,E as SortDescending,R as SwitchAIProvider,O as ToggleAIEnabled,H as ToggleSortDirection,W as ToggleVoiceInput,j as TypeFilterScript,q as VeryLongScript,U as VoiceInputBrowser,w as VoiceInputDisabled,T as VoiceInputGemini,k as VoiceInputOpenAI,f as WithCustomBaseURL,V as WithSelectedTags,y as WithTokenUsage,ge as __namedExportsOrder,ce as default};
